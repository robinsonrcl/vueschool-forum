...
export default {
  ...
  fetchUser: ({ dispatch }, { id }) => dispatch('fetchItem', { emoji: 'c', resource: 'users', id }),
  fetchAuthUser: ({ dispatch, state }) => dispatch('fetchItem', { emoji: '🙋‍♀️', resource: 'users', id: state.authId }),
